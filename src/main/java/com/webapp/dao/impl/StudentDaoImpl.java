...
public class StudentDaoImpl extends UserDaoImpl implements StudentDao {
    ...
    public boolean saveStudent(Student student) {
        ...
        String sql = "INSERT INTO student(id, student_id) VALUES(?,?)";
        try {
    ...
    public boolean modifyStudent(Student student) {
        ...
        String sql = "UPDATE student SET student_id=? WHERE `id`=?";
    ...
    public Student queryInfoById(int id) {
        ...
        sql = "SELECT `student_id` studentId FROM student WHERE `id`=?";
